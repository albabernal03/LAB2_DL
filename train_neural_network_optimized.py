...
def create_model(hidden_layers=2, neurons=64, dropout_rate=0.3, learning_rate=0.001):
    ...
    # Input layer
    model.add(Dense(neurons, activation='relu', input_shape=(3,)))
...
for idx, (hidden_layers, neurons, dropout_rate, learning_rate, batch_size) in enumerate(param_combinations, 1):
    print(f"\n[{idx}/{len(param_combinations)}] Testing: layers={hidden_layers}, neurons={neurons}, dropout={dropout_rate}, lr={learning_rate}, batch={batch_size}")
